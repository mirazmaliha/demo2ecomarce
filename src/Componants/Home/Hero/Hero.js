...
function Hero() {
  return (
    <div className='grid px-4 text-center md:text-start h-fit py-20 text-gray-300 font-bold  grid-cols-1 bg-black gap-5 md:grid-cols-2'>
       <div className='flex justify-center '>
        <div>
         ...
         <p className='my-10 text-[12px] sm:text-[15px]'>Lorem ipsum dolor  sit amet consectetur, adipisicing  elit. Tempora corporis <br /> laboriosam ea magniexpedita iusto aut  cumque ut. Sed, sequi.</p>
         <div className='md:flex gap-5'>
          <div>
            <button className='px-11 w-full md:w-fit hover:bg-orange-400 transition-all duration-200 text-white hover:shadow-2xl py-4 rounded-full bg-orange-500'>Shop Now </button>
          </div>
          <div>
            <button className='px-11 w-full mt-4 md:mt-0 md:w-fit transition-all duration-200 text-white py-4 rounded-full bg-white/5 border-2 hover:bg-white/20 border-slate-500'>Browse Categories</button>
          </div>
         </div>
