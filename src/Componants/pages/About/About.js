...
function About() {
  ...
  return (
    <div >
      <div className='w-full px-4 text-gray-500 flex justify-center bg-gray-800'>
         <div className='lg:w-[70%] pt-10 md:w-[95%]'>
          <div className='py-20 bg-gray-800 w-full md:w-1/2'>
            ...
            <p className='md:text-6xl sm:text-4xl text-2xl font-extrabold text-white my-8'>We believe in the power of  the <span className='text-orange-600'>perfect step</span></p>
    ...
    <div className={`flex font-bold border-b-[1px]  ${!them ? 'border-gray-700' : 'border-gray-300'}  text-gray-500  justify-center`}>
        <div className='lg:w-[70%] px-4 w-full pt-10 md:w-[95%]'>
         
          <div className='grid gap-4  py-8 grid-cols-2 md:grid-cols-4'>
              <div className='font-bold'>
                <p className='md:text-5xl text-3xl sm:text-4xl text-orange-600'>500K+</p>
                <p>Happy Customers</p>
              </div>
              <div className='font-bold'>
                <p className='md:text-5xl text-3xl sm:text-4xl text-orange-600'>200K+</p>
                <p>Shoe Styles</p>
              </div>
              <div className='font-bold'>
                <p className='md:text-5xl text-3xl sm:text-4xl text-orange-600'>15</p>
                <p>Countries Served</p>
              </div>
              <div className='font-bold'>
                <p className='md:text-5xl text-3xl sm:text-4xl text-orange-600'>4.9</p>
                <p>Average Rating</p>
              </div>
          </div>
        </div>
    ...
    <div className={`flex ${!them ? 'bg-gray-900' : 'bg-gray-50'} justify-center text-bold text-gray-500`}>
        <div className='lg:w-[70%] px-4 my-28 pt-10 md:w-[95%]'>
           <div>
    ...
    <div className='flex justify-center'>
      <div className='lg:w-[70%] mx-4 rounded-3xl py-28 my-10 flex justify-center text-center font-bold pt-10 bg-orange-600 md:w-[95%]'>
         <div>
         ...
         <div className='w-full flex justify-center'>
          <div className='sm:flex  mt-8 justify-center gap-4'>
            <button className='flex justify-center items-center text-orange-500 bg-white w-full sm:w-fit px-8 py-4 rounded-full hover:bg-gray-100 transition-all duration-200'>Shop now <GoArrowRight /></button>
            <button className=' mt-3 sm:mt-0 text-white px-8 py-4 rounded-full border-[2px] transition-all border-orange-300 hover:border-white duration-200'>Browse Categories</button>
         </div>
         </div>
         </div>
      </div>
